...
public class LightSensor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lightMessage = (TextView) findViewById(R.id.textView2);

        if (lightSensor == null) {
            Toast.makeText(this, "Light sensor is not available !", Toast.LENGTH_LONG).show();
            lightMessage.setText("Light sensor is not available in your device.");
//            finish();
        }
        else{
    ...
    //                    Log.d("SENSOR: ", String.valueOf(sensorEvent.values[0]));
        ...
        Button ardButton = (Button) findViewById(R.id.ardButton);
        ardButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent myIntent = new Intent(LightSensor.this, ArduinoConnect.class);
